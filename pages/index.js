    ...
    <>
            ...
            <Box>
              ...
              <Box overflow="hidden" backgroundColor="white">
                ...
                <Box>
                  ...
                  <Text textAlign="center" mx={5} mt={2} fontWeight="light">
      ...
      <Box mx={4} my={2} textAlign="center">
        ...
        <Text fontWeight="light" mt={4} mb={4}>
          The Better. App was created to help you manage your own personal goals and start improving the parts of your life that are a bit out of wack. Struggling to get enough nutrients each day? Track your meals to manage your calorie intake and hit those macros. Consistently have the Monday blues? Find activities that can improve your mood over time. Hitting the gym is already hard enough but seeing how many calories you've burned may motivate you to keep going. And at least 8 hours of sleep may reduce your need for morning coffee from 3 cups to 2. Get started today to start feeling, well   ...   'better'.
        </Text>
      </Box>
    </>
  )
